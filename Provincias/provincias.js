...
function pintarDatos(provincia) {
  ...
  document.getElementById("monuments1_img").textContent =
    provincia.monuments1_h3 || "Monumento no disponible";
  document.getElementById("monuments2_h3").textContent =
    provincia.monuments2_h3 || "Monumento no disponible";
  document.getElementById("monuments2_img").textContent =
    provincia.monuments1_h3 || "Monumento no disponible";
  document.getElementById("monuments3_h3").textContent =
    provincia.monuments3_h3 || "Monumento no disponible";
  document.getElementById("monuments3_img").textContent =
    provincia.monuments1_h3 || "Monumento no disponible";

  // Gastronomía
  document.getElementById("gastronomy_p").textContent =
    provincia.gastronomy_p || "No hay datos de gastronomía.";
  document.getElementById("gastronomy_1_li_title").textContent =
    provincia.gastronomy_p || "No hay datos de gastronomía.";
  document.getElementById("gastronomy_1_li_phrase").textContent =
    provincia.gastronomy_p || "No hay datos de gastronomía.";
  document.getElementById("gastronomy_2_li_title").textContent =
    provincia.gastronomy_p || "No hay datos de gastronomía.";
  document.getElementById("gastronomy_2_li_phrase").textContent =
    provincia.gastronomy_p || "No hay datos de gastronomía.";
  document.getElementById("gastronomy_3_li_title").textContent =
    provincia.gastronomy_p || "No hay datos de gastronomía.";
  document.getElementById("gastronomy_3_li_phrase").textContent =
    provincia.gastronomy_p || "No hay datos de gastronomía.";
